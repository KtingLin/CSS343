...
void buildTree(BinTree& T, ifstream& infile) {
	...
	for (;;) {
		...
		// could do a setData for reading to keep it object-oriented
...
int main()
{
	...
	NodeData *g = new NodeData("g");
	NodeData *h = new NodeData("h");
	NodeData *i = new NodeData("i");
	NodeData key("e");
	tree.insert(a);
	tree.insert(b);
	tree.insert(c);
	...
	tree.insert(i);
	cout << tree << endl;
	tree.bstreeToArray(arr);
	tree.arrayToBSTree(arr);
	tree.displaySideways();
	cout << tree.getHeight(key) << endl;
}